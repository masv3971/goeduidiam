...
// Client holds the object of sunetjwt
type Client struct {
...
// Config holds the configuration for sunetjwt
type Config struct {
	Certificate []byte
	PrivateKey  []byte
	Password    string
...
// New creates a new instance of sunetjwt
...
func (c *Client) newRequest(ctx context.Context, method, path string, body interface{}) (*http.Request, error) {
	...
	req.Header.Set("User-Agent", "goeduidiam")
	return req, nil
}
